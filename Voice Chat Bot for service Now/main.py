'''
Author - Akhil Vydyula
Edited by - 28-09-2022
'''
...
arc=Article('https://www.recycleyourtec.com/10-common-laptop-faults-solutions/#:~:text=10%20Common%20Laptop%20Faults%20%26%20Solutions%201%20Solution%3A,Solution%3A%20Massage%20away%20dead%20pixels%20...%20More%20items')
arc.download()
arc.parse()
arc.nlp()
corpus=arc.text
...
root.title(f"Chat Bot - Conversation.txt")
...
mes_win.focus()
textcon.config(fg='yellow')
textcon.tag_config('usr',foreground='yellow')
textcon.insert(END,"Bot: This is your chat bot to assist you about Tickets for Service Now!\n\n")
mssg=mes_win.get()
button=Button(root,text='Send',bg='red',activebackground='white',command=send,width=12,height=5,font=('Arial'))
